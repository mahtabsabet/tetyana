// level04-chateau/LevelScene.js — Le Château Hanté
//
// GROUPE 4 — votre niveau commence ici !
...
// ── Questions vocabulaire — PLACEHOLDERS (groupe 4 : remplacez par vos vraies questions !) ──
const QUIZ_QUESTIONS = [
  {
    imageEmoji: '🏰',
    correct: 'Le château',
    wrong:   ['La maison', 'La tour', 'Le palais'],
  },
  {
    imageEmoji: '👻',
    correct: 'Le fantôme',
    wrong:   ['Le monstre', 'Le vampire', 'Le zombie'],
  },
];

const BG_COLOR         = 0x2a1a2a;
...
export class ChateauScene extends Phaser.Scene {
  ...
  preload() {
    ...
    // this.load.image('chateau_bg',   new URL('./assets/backgrounds/bg.png',   import.meta.url).href);
    // this.load.image('chateau_coin', new URL('./assets/sprites/collectible.png', import.meta.url).href);
    // this.load.image('chateau_goal', new URL('./assets/sprites/goal.png',     import.meta.url).href);
  }
  ...
  create() {
    ...
    this.add.text(W / 2, H / 2 + 100, 'À construire par le groupe 4 !', {
    ...
    // ── Obstacles (fantômes — réduisent les points de vie au contact) ─────────
